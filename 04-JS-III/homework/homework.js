...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  let comprobante = array.includes(elemento);
  return comprobante;
}
...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  let valorEntero = numeros.reduce((a, b) => {return a + b;} );
  return valorEntero;
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código: 
  let suma = resultadosTest.reduce((a,b) => {return a + b;});
...
function mayorACien(array) {
  ...
  // Tu código:
  let mayor100 = array.filter(may => may > 100)
  return mayor100;
}
